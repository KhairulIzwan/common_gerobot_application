...
class CameraPreview:
	def __init__(self):
		...
		rospy.logwarn("CameraPreview PC Node [ONLINE]...")
...
#		self.cv_image = cv2.flip(self.cv_image, 1)
		...
		cv2.imshow("CameraPreview PC", self.cv_image)
		cv2.waitKey(1)
...
#			self.cbInfo()
	...
	def cbShutdown(self):
		...
		rospy.logerr("CameraPreview Node PC [OFFLINE]...")
		cv2.destroyAllWindows()

if __name__ == '__main__':

	# Initialize
	rospy.init_node('pc_camera_preview', anonymous=False)
