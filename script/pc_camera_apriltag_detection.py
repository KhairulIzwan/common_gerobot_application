...
#			self.cv_image = self.image.copy()
	...
	def cbShowImage(self):
		...
		cv2.imshow("AprilTag Detection PC", self.cv_image)
		cv2.waitKey(1)
...
#			self.cbShowImage()
	...
	def cbShutdown(self):
		...
		rospy.logerr("AprilTag Detection PC Node [OFFLINE]...")
		cv2.destroyAllWindows()

if __name__ == '__main__':

	# Initialize
	rospy.init_node('pc_camera_apriltag_detection', anonymous=False)
